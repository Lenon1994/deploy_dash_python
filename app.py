...
app.layout = html.Div(children=[
                dbc.Row([
                    dbc.Col([
                        dbc.Card([
                            html.H2("DASH VENDAS", style={"font-family": "Voltaire", "font-size": "22px", "margin-left": "20px"}),
                            html.Hr(),
                            ...
                            html.H5("Variável de análise:", style={"margin-top": "22px"}),
...
if __name__ == "__main__":
    ...
    #app.run_server(debug=False,port=8080,host='0.0.0.0') #Para todos que acessam a mesma rede wifi local
    
    #Alternativas para deploy cloud
    #heroku
    #render
    #aws
    #google
